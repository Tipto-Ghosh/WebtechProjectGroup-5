...
function getLatestStudentAttemptId(int $student_id): int
{
...
function getAttemptById(int $attempt_id): array
{
    $connection = get_database_connection();
...
function getAnswerBreakdown(int $attempt_id): array
{
    $connection = get_database_connection();
    ...
    $sql = "
        ...
        JOIN options selected ON selected.id = ans.selected_option_id
        JOIN options correct
